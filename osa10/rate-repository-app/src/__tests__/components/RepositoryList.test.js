...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', async () => {
      ...
      expect(within(firstRepositoryItem).getByText('1.6k')).toHaveTextContent(
        '1.6k',
      );
      expect(within(firstRepositoryItem).getByText('21.9k')).toHaveTextContent(
        '21.9k',
      );
      expect(within(firstRepositoryItem).getByText('88')).toHaveTextContent(
        '88',
      );
      ...
      expect(within(secondRepositoryItem).getByText('69')).toHaveTextContent(
        '69',
      );
      expect(within(secondRepositoryItem).getByText('1.8k')).toHaveTextContent(
        '1.8k',
      );
      expect(within(secondRepositoryItem).getByText('72')).toHaveTextContent(
        '72',
      );
      expect(within(secondRepositoryItem).getByText('3')).toHaveTextContent(
        '3',
      );
    });
  });
